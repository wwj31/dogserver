...
type ModifyGoldReq struct {
	...
	SetOrAdd bool  `protobuf:"varint,2,opt,name=SetOrAdd,proto3" json:"SetOrAdd,omitempty"`
}
...
func (m *ModifyGoldReq) GetSetOrAdd() bool {
	if m != nil {
		return m.SetOrAdd
	}
	return false
...
var fileDescriptor_db1b6b0986796150 = []byte{
	...
	,
}
...
func (m *ModifyGoldReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SetOrAdd", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
