...
func (m *ItemMap) GetItems() map[int64]int64 {
	if m != nil {
		return m.Items
	}
	return nil
...
func init() {
	proto.RegisterType((*ItemMap)(nil), "inner.ItemMap")
	proto.RegisterMapType((map[int64]int64)(nil), "inner.ItemMap.ItemsEntry")
}
...
var fileDescriptor_1747d3070a2311a0 = []byte{
	...
	,
}

func (m *ItemMap) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *ItemMap) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ItemMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ItemMap) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ItemMap: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ItemMap: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
