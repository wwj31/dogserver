...
func (x *JoinAllianceNtf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JoinAllianceNtf) ProtoMessage() {}

func (x *JoinAllianceNtf) ProtoReflect() protoreflect.Message {
	mi := &file_alliance_proto_msgTypes[0]
...
// Deprecated: Use JoinAllianceNtf.ProtoReflect.Descriptor instead.
func (*JoinAllianceNtf) Descriptor() ([]byte, []int) {
	return file_alliance_proto_rawDescGZIP(), []int{0}
}

func (x *JoinAllianceNtf) GetAllianceId() int32 {
	if x != nil {
		return x.AllianceId
	}
	return 0
...
func (x *JoinAllianceNtf) GetPosition() int32 {
	if x != nil {
		return x.Position
	}
	return 0
...
var file_alliance_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x1a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x0f, 0x4a, 0x6f, 0x69, 0x6e, 0x41, 0x6c, 0x6c, 0x69, 0x61,
	0x6e, 0x63, 0x65, 0x4e, 0x74, 0x66, 0x12, 0x1e, 0x0a, 0x0a, 0x41, 0x6c, 0x6c, 0x69, 0x61, 0x6e,
	...
	0x6f, 0x6e, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_alliance_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_alliance_proto_goTypes = []interface{}{
	(*JoinAllianceNtf)(nil), // 0: outer.JoinAllianceNtf
}
