...
type FasterRunParams struct {
	...
	PlayCountLimit           int32         `protobuf:"varint,1,opt,name=playCountLimit,proto3" json:"playCountLimit,omitempty"`                      // 必须打满多少局才能退出
	BaseScore                int32         `protobuf:"varint,2,opt,name=BaseScore,proto3" json:"BaseScore,omitempty"`                                // 底分
	BaseScoreTimes           float32       `protobuf:"fixed32,3,opt,name=BaseScoreTimes,proto3" json:"BaseScoreTimes,omitempty"`                     // 倍数
	...
	DicedeMasterType         int32         `protobuf:"varint,6,opt,name=DicedeMasterType,proto3" json:"DicedeMasterType,omitempty"`                  // 选庄 0.随机 1.黑桃三 2.赢家 3.首局黑桃三，之后赢家
...
func (x *FasterRunParams) GetBaseScore() int32 {
	if x != nil {
		return x.BaseScore
	}
	return 0
...
func (x *FasterRunParams) GetDicedeMasterType() int32 {
	if x != nil {
		return x.DicedeMasterType
	}
	return 0
}
...
var file_base_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2a, 0x0a, 0x10, 0x44, 0x69, 0x63, 0x65,
	0x64, 0x65, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x10, 0x44, 0x69, 0x63, 0x65, 0x64, 0x65, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72,
