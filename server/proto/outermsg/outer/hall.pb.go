...
func (x *SetIconReq) GetIcon() string {
	if x != nil {
		return x.Icon
	}
	return ""
...
func (x *SetIconRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetIconRsp) ProtoMessage() {}

func (x *SetIconRsp) ProtoReflect() protoreflect.Message {
	mi := &file_hall_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetIconRsp.ProtoReflect.Descriptor instead.
func (*SetIconRsp) Descriptor() ([]byte, []int) {
	return file_hall_proto_rawDescGZIP(), []int{1}
}

func (x *SetIconRsp) GetIcon() string {
	if x != nil {
		return x.Icon
	}
	return ""
...
var file_hall_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x22, 0x20, 0x0a, 0x0a, 0x53, 0x65, 0x74, 0x49, 0x63, 0x6f, 0x6e, 0x52, 0x65,
	0x71, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x69, 0x63, 0x6f, 0x6e, 0x22, 0x20, 0x0a, 0x0a, 0x53, 0x65, 0x74, 0x49, 0x63, 0x6f, 0x6e,
	0x52, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x22, 0x40, 0x0a, 0x0c, 0x42, 0x69, 0x6e, 0x64, 0x50,
...
var file_hall_proto_goTypes = []interface{}{
	(*SetIconReq)(nil),   // 0: outer.SetIconReq
	(*SetIconRsp)(nil),   // 1: outer.SetIconRsp
