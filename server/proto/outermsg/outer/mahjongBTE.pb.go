...
type MahjongBTEGameInfo struct {
	...
	Players         []*MahjongPlayerInfo `protobuf:"bytes,3,rep,name=Players,proto3" json:"Players,omitempty"`                         // 玩家信息东南西北4个位置
	MasterIndex     int32                `protobuf:"varint,4,opt,name=MasterIndex,proto3" json:"MasterIndex,omitempty"`                // 庄家位置 东南西北(0-3)
	TotalCardsCount int32                `protobuf:"varint,5,opt,name=TotalCardsCount,proto3" json:"TotalCardsCount,omitempty"`        // 剩余总牌数
	ActionShortId   int64                `protobuf:"varint,6,opt,name=ActionShortId,proto3" json:"ActionShortId,omitempty"`            // 当前执行者
	ActionType      int64                `protobuf:"varint,7,opt,name=ActionType,proto3" json:"ActionType,omitempty"`                  // 操作类型 0.过、1.碰、2.杠、3.胡
	HuType          HuType               `protobuf:"varint,8,opt,name=HuType,proto3,enum=outer.HuType" json:"HuType,omitempty"`        // 胡牌类型
	NewCard         int32                `protobuf:"varint,9,opt,name=NewCard,proto3" json:"NewCard,omitempty"`                        // 摸得的牌
	OpEndAt         int64                `protobuf:"varint,10,opt,name=OpEndAt,proto3" json:"OpEndAt,omitempty"`                       // 操作结束结束时间(毫秒)
}
...
type MahjongPlayerInfo struct {
	...
	DecideColor MahjongCardType `protobuf:"varint,2,opt,name=DecideColor,proto3,enum=outer.MahjongCardType" json:"DecideColor,omitempty"` // 定缺花色 1.万、2.条、3.筒
	Cards       []int32         `protobuf:"varint,3,rep,packed,name=Cards,proto3" json:"Cards,omitempty"`                                 // 手牌 (万11-19 条21-29 筒31-39)
	CardPong    []int32         `protobuf:"varint,4,rep,packed,name=CardPong,proto3" json:"CardPong,omitempty"`                           // 碰的牌组 数组长度表示几组碰，值代表牌
	CardGang    []int32         `protobuf:"varint,5,rep,packed,name=CardGang,proto3" json:"CardGang,omitempty"`                           // 杠的牌组 数组长度表示几组杠，值代表牌
}
...
func (x *MahjongPlayerInfo) GetDecideColor() MahjongCardType {
	if x != nil {
		return x.DecideColor
	}
	return MahjongCardType_CardUnknown
}
...
func (x *MahjongPlayerInfo) GetCardPong() []int32 {
	if x != nil {
		return x.CardPong
	}
	return nil
...
func (x *MahjongPlayerInfo) GetCardGang() []int32 {
	if x != nil {
		return x.CardGang
	}
	return nil
...
type MahjongBTEDecideIgnoreReq struct {
	...
	Color MahjongCardType `protobuf:"varint,1,opt,name=color,proto3,enum=outer.MahjongCardType" json:"color,omitempty"` // 1.万、2.条、3.筒
}
...
func (x *MahjongBTEDecideIgnoreReq) GetColor() MahjongCardType {
	if x != nil {
		return x.Color
	}
	return MahjongCardType_CardUnknown
...
type MahjongBTEOperateReq struct {
	...
	ActionType int32 `protobuf:"varint,1,opt,name=ActionType,proto3" json:"ActionType,omitempty"` // 0.过、1.碰、2.杠、3.胡
}
...
func (x *MahjongBTEOperateReq) GetActionType() int32 {
	if x != nil {
		return x.ActionType
	}
	return 0
...
type MahjongBTEExchange3EndNtf struct {
	...
	Cards        []int32 `protobuf:"varint,4,rep,packed,name=Cards,proto3" json:"Cards,omitempty"`               // 最新手牌 (万11-19 条21-29 筒31-39)
}
...
type MahjongBTEPlayingNtf struct {
	...
	Colors map[int64]MahjongCardType `protobuf:"bytes,1,rep,name=Colors,proto3" json:"Colors,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=outer.MahjongCardType"` // 每位玩家的定缺花色 map<短ID，定缺花色>
}
...
func (x *MahjongBTEPlayingNtf) GetColors() map[int64]MahjongCardType {
	if x != nil {
		return x.Colors
	}
	return nil
...
type MahjongBTETurnNtf struct {
	...
	ActionType    int32  `protobuf:"varint,3,opt,name=ActionType,proto3" json:"ActionType,omitempty"`           // 操作类型，1.碰、2.杠、3.胡、4.出牌
...
func (x *MahjongBTETurnNtf) GetActionType() int32 {
	if x != nil {
		return x.ActionType
	}
	return 0
...
var file_mahjongBTE_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87, 0x03, 0x0a,
	...
	0x74, 0x65, 0x72, 0x41, 0x74, 0x12, 0x32, 0x0a, 0x07, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x2e, 0x4d,
	...
	,
	...
	0x52, 0x07, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x54, 0x68, 0x72,
	0x65, 0x65, 0x43, 0x61, 0x72, 0x64, 0x4f, 0x75, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52,
	0x0c, 0x54, 0x68, 0x72, 0x65, 0x65, 0x43, 0x61, 0x72, 0x64, 0x4f, 0x75, 0x74, 0x12, 0x20, 0x0a,
	0x0b, 0x54, 0x68, 0x72, 0x65, 0x65, 0x43, 0x61, 0x72, 0x64, 0x49, 0x6e, 0x18, 0x03, 0x20, 0x03,
	0x28, 0x05, 0x52, 0x0b, 0x54, 0x68, 0x72, 0x65, 0x65, 0x43, 0x61, 0x72, 0x64, 0x49, 0x6e, 0x12,
	0x14, 0x0a, 0x05, 0x43, 0x61, 0x72, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x05, 0x52, 0x05,
	...
	0x74, 0x66, 0x22, 0xaa, 0x01, 0x0a, 0x14, 0x4d, 0x61, 0x68, 0x6a, 0x6f, 0x6e, 0x67, 0x42, 0x54,
	0x45, 0x50, 0x6c, 0x61, 0x79, 0x69, 0x6e, 0x67, 0x4e, 0x74, 0x66, 0x12, 0x3f, 0x0a, 0x06, 0x43,
	0x6f, 0x6c, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6f, 0x75,
	0x74, 0x65, 0x72, 0x2e, 0x4d, 0x61, 0x68, 0x6a, 0x6f, 0x6e, 0x67, 0x42, 0x54, 0x45, 0x50, 0x6c,
	0x61, 0x79, 0x69, 0x6e, 0x67, 0x4e, 0x74, 0x66, 0x2e, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x73, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x73, 0x1a, 0x51, 0x0a, 0x0b,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x6f,
	0x75, 0x74, 0x65, 0x72, 0x2e, 0x4d, 0x61, 0x68, 0x6a, 0x6f, 0x6e, 0x67, 0x43, 0x61, 0x72, 0x64,
	0x54, 0x79, 0x70, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22,
	0xdc, 0x01, 0x0a, 0x11, 0x4d, 0x61, 0x68, 0x6a, 0x6f, 0x6e, 0x67, 0x42, 0x54, 0x45, 0x54, 0x75,
	...
	0x74, 0x65, 0x72, 0x2e, 0x48, 0x75, 0x54, 0x79, 0x70, 0x65, 0x52, 0x06, 0x48, 0x75, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x4e, 0x65, 0x77, 0x43, 0x61, 0x72, 0x64, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x07, 0x4e, 0x65, 0x77, 0x43, 0x61, 0x72, 0x64, 0x12, 0x20, 0x0a, 0x0b,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x64, 0x41, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0b, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x64, 0x41, 0x74, 0x22, 0x8b,
	0x01, 0x0a, 0x12, 0x4d, 0x61, 0x68, 0x6a, 0x6f, 0x6e, 0x67, 0x42, 0x54, 0x45, 0x4f, 0x70, 0x65,
	...
	0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x4f, 0x70, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x06, 0x4f, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x25, 0x0a, 0x06, 0x48,
	0x75, 0x54, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x6f, 0x75,
	0x74, 0x65, 0x72, 0x2e, 0x48, 0x75, 0x54, 0x79, 0x70, 0x65, 0x52, 0x06, 0x48, 0x75, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x4f, 0x70, 0x45, 0x6e, 0x64, 0x41, 0x74, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x07, 0x4f, 0x70, 0x45, 0x6e, 0x64, 0x41, 0x74, 0x42, 0x08, 0x5a, 0x06,
...
var file_mahjongBTE_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_mahjongBTE_proto_goTypes = []interface{}{
	...
	(*MahjongBTEExchange3Req)(nil),    // 2: outer.MahjongBTEExchange3Req
	(*MahjongBTEExchange3Rsp)(nil),    // 3: outer.MahjongBTEExchange3Rsp
	(*MahjongBTEDecideIgnoreReq)(nil), // 4: outer.MahjongBTEDecideIgnoreReq
	(*MahjongBTEDecideIgnoreRsp)(nil), // 5: outer.MahjongBTEDecideIgnoreRsp
	(*MahjongBTEDealReq)(nil),         // 6: outer.MahjongBTEDealReq
	(*MahjongBTEDealRsp)(nil),         // 7: outer.MahjongBTEDealRsp
	(*MahjongBTEOperateReq)(nil),      // 8: outer.MahjongBTEOperateReq
	(*MahjongBTEOperateRsp)(nil),      // 9: outer.MahjongBTEOperateRsp
	(*MahjongBTEDealNtf)(nil),         // 10: outer.MahjongBTEDealNtf
	(*MahjongBTEExchange3Ntf)(nil),    // 11: outer.MahjongBTEExchange3Ntf
	(*MahjongBTEExchange3EndNtf)(nil), // 12: outer.MahjongBTEExchange3EndNtf
	(*MahjongBTEDecideIgnoreNtf)(nil), // 13: outer.MahjongBTEDecideIgnoreNtf
	(*MahjongBTEPlayingNtf)(nil),      // 14: outer.MahjongBTEPlayingNtf
	(*MahjongBTETurnNtf)(nil),         // 15: outer.MahjongBTETurnNtf
	(*MahjongBTEOperaNtf)(nil),        // 16: outer.MahjongBTEOperaNtf
	nil,                               // 17: outer.MahjongBTEPlayingNtf.ColorsEntry
	(MahjongBTEState)(0),              // 18: outer.MahjongBTEState
	(HuType)(0),                       // 19: outer.HuType
	(MahjongCardType)(0),              // 20: outer.MahjongCardType
}
var file_mahjongBTE_proto_depIdxs = []int32{
	18, // 0: outer.MahjongBTEGameInfo.State:type_name -> outer.MahjongBTEState
	1,  // 1: outer.MahjongBTEGameInfo.Players:type_name -> outer.MahjongPlayerInfo
	19, // 2: outer.MahjongBTEGameInfo.HuType:type_name -> outer.HuType
	20, // 3: outer.MahjongPlayerInfo.DecideColor:type_name -> outer.MahjongCardType
	20, // 4: outer.MahjongBTEDecideIgnoreReq.color:type_name -> outer.MahjongCardType
	17, // 5: outer.MahjongBTEPlayingNtf.Colors:type_name -> outer.MahjongBTEPlayingNtf.ColorsEntry
	19, // 6: outer.MahjongBTETurnNtf.HuType:type_name -> outer.HuType
	19, // 7: outer.MahjongBTEOperaNtf.HuType:type_name -> outer.HuType
	20, // 8: outer.MahjongBTEPlayingNtf.ColorsEntry.value:type_name -> outer.MahjongCardType
